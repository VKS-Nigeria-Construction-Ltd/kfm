            ...
            <Container>
                <Row>
                    <Col className="col-12 col-md-2">
                        <img src={kfmLogoWhite} alt="KFM Logo" className="img-fluid footer-logo" />
                    </Col>
                    ...
                    <Col className="col-12 col-md-3">
                        <ul className="social-links d-flex justify-content-end">
                            <li className="mr-2">
                                <a href="https://www.facebook.com/kingsflourmill/" target="_blank" rel="noopener noreferrer"><FaFacebook color="#fff" /></a>
                            </li>                            
                            <li className="mr-2">
                                <a href="https://www.facebook.com/kingsflourmill/" target="_blank" rel="noopener noreferrer"><FaTwitter color="#fff" /></a>
                            </li>
                            <li className="mr-2">
                                <a href="https://www.instagram.com/kingsflourmill/" target="_blank" rel="noopener noreferrer"><FaInstagram color="#fff" /></a>
                            </li>
                            <li>
                                <a href="https://www.linkedin.com/company/kings-flour-mill/" target="_blank" rel="noopener noreferrer"><FaLinkedin color="#fff" /></a>
                            </li>
                        </ul>
                    </Col>
                </Row>
