    ...
    return (
      <Container className="main-section">
          <Row>
            ...
            <Col className="right_border col-12 col-md-4 animate_feature">
                ...
                <a className="text-uppercase text-dark" href="/#">Read more</a>
            </Col>
            <Col className="col-12 col-md-4 animate_feature">
